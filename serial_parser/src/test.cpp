			...
			if (ser.available()) {
				...
				if (ec.Uart_payload > 0 && ec.delimiter_flag == true) {
					...
					// double mod_robot_acc_x;
						...
						//if (data_array.data[0] == 0 && data_array.data[4] == 0 && data_array.data[6] == 0 && (data_array.data[5] == 0 || data_array.data[5] == 3 || data_array.data[5] == 4)) { //#

						//if (data_array.data[0] == 0 && ( data_array.data[1] != 0 || data_array.data[2] != 0 || data_array.data[3] != 0)) /*if value is over threshold it activates*/ {

							if (data_array.data[0] == 0 && data_array.data[1] != 0) { //#4 careless

								if (ec.set_param(ec.conf, ec.DEFAULT_ROBOT_VEL_X, ec.DEFAULT_ROBOT_ACC_X, 0.0, 2.0)) ROS_INFO("speed -> 0 acceleration -1x");

							}

							else if (data_array.data[0] == 0 && data_array.data[1] == 0) { //#2
						...
						if (data_array.data[4] == 0 && (data_array.data[5] == 1 || data_array.data[5] == 2)) {
							...
							if (data_array.data[5] == 1) { //#1

								if (data_array.data[0] == 0 && data_array.data[2] == 1) {
							...
							else if (data_array.data[0] == 0 && data_array.data[5] == 2 && (data_array.data[3] == 1 && data_array.data[1] != 0)) { //#5

								if (ec.set_param(ec.conf, ec.DEFAULT_ROBOT_VEL_X, ec.DEFAULT_ROBOT_ACC_X, 0.0, 2.0)) ROS_INFO("speed -> 0 acceleration -2x");

							}

							else if (data_array.data[0] == 0 && data_array.data[2] == 1) { //#1
